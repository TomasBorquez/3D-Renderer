...
Vec3 Vec3Cross(Vec3 a, Vec3 b) {
  return (Vec3){.x = a.y * b.z - b.y * a.z, .y = a.x * b.z - b.x * a.z, .z = a.x * b.y - a.y * b.x};
}
...
Vec3 M2V(Mat4 m) {
  return (Vec3){m.a[Mat4Get(0, 0)] / m.a[Mat4Get(3, 0)], m.a[Mat4Get(1, 0)] / m.a[Mat4Get(3, 0)], m.a[Mat4Get(2, 0)] / m.a[Mat4Get(3, 0)]};
}
